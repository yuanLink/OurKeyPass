...
class Ui_new_file_dialog(object):
    def setupUi(self, new_file_dialog):
        ...
        self.widget = QtGui.QWidget(new_file_dialog)
        self.widget.setGeometry(QtCore.QRect(61, 52, 207, 115))
        ...
        self.userPasswordInput = QtGui.QLineEdit(self.widget)
        ...
        self.userMemoryInput = QtGui.QLineEdit(self.widget)
        self.userMemoryInput.setObjectName(_fromUtf8("userMemoryInput"))
        self.horizontalLayout_4.addWidget(self.userMemoryInput)
        self.verticalLayout_2.addLayout(self.horizontalLayout_4)
        self.formLayout.setLayout(0, QtGui.QFormLayout.LabelRole, self.verticalLayout_2)
        self.horizontalLayout_3 = QtGui.QHBoxLayout()
        self.horizontalLayout_3.setObjectName(_fromUtf8("horizontalLayout_3"))
        self.NewFileOKButton = QtGui.QPushButton(self.widget)
        self.NewFileOKButton.setObjectName(_fromUtf8("NewFileOKButton"))
        self.horizontalLayout_3.addWidget(self.NewFileOKButton)
        self.NewFileCancelButton = QtGui.QPushButton(self.widget)
